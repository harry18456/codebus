# qa-overlay Specification

## Purpose

TBD - created by archiving change 'qa-overlay-p0'. Update Purpose after archive.
...
tests:
  - web/tests/qa/fixtures/kb-growth.json
  - web/tests/qa/fixtures/qa-stream.json
  - web/tests/qa/QaCitations.spec.ts
  - web/tests/qa/QAEntry-imperative.spec.ts
  - web/tests/qa/fixtures/README.md
