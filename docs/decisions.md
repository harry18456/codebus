...
**狀態**：✅ 已補進 README（2026-04-17）；✅ harness 落地 P0 形狀（2026-04-25，`explorer-judge-golden`）；完整評估 rubric 落地延後至打磨期
**討論日期**：2026-04-17
...
**Golden harness 落地形狀**（`explorer-judge-golden`，2026-04-25）
...
- [x] 建立 `tests/golden/` 放 ideal routes（`demo-synthetic/` 落地 2026-04-25；`timeline-storage-adapter-synthetic/` 落地 2026-04-25 via `golden-sample-baseline`）
