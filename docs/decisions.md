...
- [ ] Agent console 元件（顯示 reasoning_log 即時 stream；前端 Stage 6 步驟 28）— **propose 完 parked** 為 `agent-console-p0`（19 task / 0 完成，含 `pages/explorer/[task_id].vue` + 4 console 元件 + `useExplorerStream` composable + vitest fixture）；D-033 Change A 已於 2026-04-29 落地後即可 `/spectra-apply agent-console-p0`
