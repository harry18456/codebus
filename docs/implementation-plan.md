...
| # | 項目 | 工期 | 依賴 | 關聯 spec |
|---|---|---|---|---|
| 13 | **Module 1 P0**：遍歷 + gitignore + binary/encoding + ScanResult | 2d | 5, 9 | module-1-scanner.md §十六 P0 |
| 14 | **Module 2 P0**：Qdrant wrapper + KBPayload + chunk + embed pipeline + content-hash 去重 | 2.5d | 7, 8, 13 | module-2-kb-builder.md §十三 P0 |
...
| 20 | Coverage Checker + gap 補查遞迴 | 1d | 18, 19 | agent-core.md §五 |
