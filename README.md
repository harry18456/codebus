...
codebus 已內建幾層 sandbox（cwd 隔離、tool whitelist、PII filter、nested git 可隨時還原），但 sandbox 不是萬靈丹。完整 threat model 跟每層 sandbox 怎麼運作：[`docs/security.md`](docs/security.md)。
