...
//! `related[]` format violations as Errors.
//!
//! Target-resolution for `related[]` (does the slug point to an existing
//! page?) is the responsibility of [`super::broken_wikilink`].
